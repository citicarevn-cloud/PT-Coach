    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_#ccfbf1_0,_#f8fafc_42%)] px-4 py-8 sm:py-12">
      <div className="mx-auto max-w-xl">
        <header className="mb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-slate-600">{isEditMode ? "Điều chỉnh thông tin bên dưới để AI tạo lại roadmap, macro và chi tiết bài tập Hubert Cù." : "Cho AI vài chỉ số cơ bản. Bạn sẽ nhận mục tiêu active calories hợp lý và lịch tập có ngày phục hồi."}</p>
          <Link href="/settings" className="mt-4 inline-flex items-center gap-2 rounded-xl bg-white px-3 py-2 text-xs font-extrabold text-teal-700 shadow-sm"><Settings size={15} /> Cài đặt AI API Keys</Link>
        </header>
